class E2C_Config:
    ...
    img_height: int = 32
    img_width: int = 32
    channels_per_img: int = 1      # grayscale
    latent_dim: int = 32
    state_seq_len: int = 1 # number of images to concat along channel to ensure Markov property
    vae_type: str = "conv" 

    # Conv VAE architecture (encoder/decoder mirror)
    ...
    ## DYNAMICS
    latent_dynamics_model_type: str = "rnn"  # "rnn" or "mlp"
    # MLP transition hidden layers
    mlp_hidden_dims: list[int] = [100, 100]
    # RNN
    rnn_hidden_dim: int = 256
    rnn_seq_len: int = 20          # number of frames concatenated along channel dim
